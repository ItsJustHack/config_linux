...
static const char *altbarcmd        = "$HOME/.config/polybar/launch.sh --pwidgets"; /* Alternate bar launch command */
static const char *fonts[]          = { "monospace:size=15", "fontawesome:size=20" };
...
static Button buttons[] = {
	/* click                event mask      button          function        argument */ { ClkLtSymbol,          0,              Button1,        setlayout,      {0} },
